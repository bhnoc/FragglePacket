...
use super::app::{
    App, FuzzingStatus, TERM_AMBER, TERM_BLACK, TERM_CYAN, TERM_GREEN,
    TERM_GREEN_DIM, TERM_RED,
};
...
pub fn render_fuzzing_panel(frame: &mut Frame, area: Rect, app: &App) {
    ...
    for (mode, result) in &state.fuzzing_results {
        ...
        rows.push(Row::new(vec![
            ...
            Cell::from(format!("{}KB", result.file_size_bytes / 1024))
    ...
    .row_highlight_style(Style::default().fg(TERM_BLACK).bg(TERM_GREEN));
