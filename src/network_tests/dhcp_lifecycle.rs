...
server_identifier (ip): 10.220.250.1\n\
subnet_mask (ip): 255.255.255.0\n\
router (ip_mult): {10.220.250.1}\n\
domain_name (string): internal.example.com\n\
domain_name_server (ip_mult): {172.16.16.16, 172.16.16.17, 208.67.222.222}\n\
end (none):\n";
    ...
    fn parses_real_capture_fields() {
        ...
        assert_eq!(lease.server_identifier, Some("10.220.250.1".to_string()));
